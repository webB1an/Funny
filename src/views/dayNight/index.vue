<template>
  <div id="fullpage" :class="{'night': switchVal}">
    <div class="section">
...
.sun {
  margin-top: 20px;
  background: #f2ef88;
  box-shadow: 0 0 20px rgba(242, 239, 136, .4);
  width: 30%;
  height: 30%;
  border-radius: 50%;
  position: relative;
...
@keyframes pulse {
  0% { box-shadow: 0 0 20px rgba(242, 239, 136, .4); }
  50% { box-shadow: 0 0 40px rgba(242, 239, 136, 1); }
  100% { box-shadow: 0 0 20px rgba(242, 239, 136, .4); }
}
